Public Class bdCategorias
    ...
    Private Sub bdCategorias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub dgCategorias_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgCategorias.CellClick
        ...
        fila = dgCategorias.Rows(indice)

        'Llena los campos de texto con el valor de cada celda de la fila.
        id_categoria.Text = fila.Cells(0).Value.ToString
        categoria.Text = fila.Cells(1).Value.ToString
    End Sub
    Private Sub dgCategorias_Cell()
        'Objetivo: Llena los campos de texto con el valor de cada celda seleccionada.
        Dim counter As Integer = 0

        Dim cell As DataGridViewCell

        For Each cell In dgCategorias.SelectedCells
            If counter = 0 Then
                id_categoria.Text = cell.Value.ToString
            ElseIf counter = 1 Then
                categoria.Text = cell.Value.ToString
            End If
            counter = counter + 1
        Next
    End Sub
    Private Sub btnCrear_Click(sender As Object, e As EventArgs) Handles btnCrear.Click
        ...
        If (Me.id_categoria.Text = "") Then
            fbSQL.Text = "El campo de ID no puede estar vacío"
            Me.id_categoria.Select()
        End If
        ...
        id = Me.id_categoria.Text
        categorias = Me.categoria.Text
        ...
        sql = "INSERT INTO Categorias (id_categoria, categoria) VALUES (" & id & ",'" & categorias & "')"
        'MsgBox(sql)
    ...
    Private Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        ...
        End Try
    End Sub
    Private Sub id_cliente_TextChanged(sender As Object, e As EventArgs) Handles id_categoria.TextChanged
        ...
        If id_categoria.Text <> "" Then
            ...
            For Each row In dgCategorias.Rows
                If Convert.ToInt32(row.Cells(0).Value) = id_categoria.Text Then
                    row.Selected = True
                    existe = True
                    eventoFeedback(1)
                    dgCategorias.CurrentCell = row.Cells(0)
                    dgCategorias_Cell()
                    Exit For
                End If
            Next
    ...
    Private Sub toggleGrid_Click(sender As Object, e As EventArgs) Handles toggleGrid.Click
        ...
        If toggledGrid = False Then
            dgCategorias.Show()
            Me.Size = New Size(609, 331)
            toggledGrid = True
        Else
            dgCategorias.Hide()
            Me.Size = New Size(347, 331)
            toggledGrid = False
        End If
    End Sub
    Private Sub btnLlenar_Click(sender As Object, e As EventArgs) Handles btnLlenar.Click
        ...
        Next
        id_categoria.Text = counterSiguiente.ToString
    End Sub
End Class